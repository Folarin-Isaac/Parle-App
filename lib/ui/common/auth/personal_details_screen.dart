...
class _PersonalDetailsScreenState extends State<PersonalDetailsScreen> {
  ...
  String? _threeYears = AppStrings.threeYears;
  String? _years = AppStrings.threeYears;
  String? _nine = AppStrings.nineAM;
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          CustomDropdown(
                            ...
                            value: _threeYears,
                            width: MediaQuery.sizeOf(context).width / 2.1,
                            items: const [AppStrings.threeYears, AppStrings.fourYears],
                            onChanged: (value) {
                              setState(() {
                                _threeYears = value;
                              });
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: CustomDropdown(
                              label: AppStrings.availableHoursPerDay,
                              value: _years,
                              items: const [
                                '5 years',
                                '10 years'
