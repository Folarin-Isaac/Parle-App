...
class AreaOfExpertiseScreen extends StatefulWidget {
  const AreaOfExpertiseScreen({super.key});

  @override
  State<AreaOfExpertiseScreen> createState() => _AreaOfExpertiseScreenState();
}

class _AreaOfExpertiseScreenState extends State<AreaOfExpertiseScreen> {
